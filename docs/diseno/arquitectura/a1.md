...
#### Recolección de datos y construcción de suministros (_feeds_) GTFS
...
**_Componentes arquitectónicos_**

| Código                  | Componente                          |
| ----------------------- | ----------------------------------- |
| **A1-backend**          | Servidor en tiempo real             |
| **A1-store**            | Base de datos                       |
| **A1-state**            | Estructura de datos en memoria      |
| **A1-realtime-engine**  | Intermediador (_broker_) pub/sub    |
| **A1-ingestion-broker** | Intermediador de ingestión de datos |
| **A1-message-broker**   | Intermediador de mensajería         |
| **A1-publisher**        | Publicador de GTFS Realtime         |
| **A1-scheduler**        | Programador de tareas               |
| **A1-analytics-engine** | Orquestador de tareas de analítica  |
...
|       Catálogo | <CatalogItem catalog="patterns" item="backend" />  |
| Implementación | [Databús RT](/desarrollo/databus/#databus-backend) |
...
| ------------------ | ----------- | -------------------------------------- |
| A1-backend-api     | API REST    | Interfaz RESTful para operaciones CRUD |
| A1-backend-graphql | API GraphQL | Interfaz de consultas flexibles        |
...
|       Catálogo | <CatalogItem catalog="applications" item="001" /> |
| Implementación | [Databús DB](/desarrollo/databus/#databus-store)  |
...
|         Código | **A1-state**                                       |
|  Clasificación | Componente de datos                                |
|       Catálogo | <CatalogItem catalog="component" item="state" />   |
| Implementación | [Databús IMDB](/desarrollo/databus/#databus-state) |
...
## Intermediador de telemetría en tiempo real
...
|       Elemento | Valor                                                          |
| -------------: | -------------------------------------------------------------- |
|         Código | **A1-telemetry-broker**                                        |
|  Clasificación | Aplicación                                                     |
|       Catálogo | <CatalogItem catalog="applications" item="telemetry-broker" /> |
| Implementación | [Databús MQTT](/desarrollo/databus/#databus-telemetry-broker)  |
...
|         Código | A1-app                                                    |
|  Clasificación | Aplicación                                                |
|       Catálogo | <CatalogItem catalog="applications" item="databus-app" /> |
