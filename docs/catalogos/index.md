...
Incluye los catálogos que definen la base conceptual y los lineamientos de la arquitectura. Describe los principios, aplicaciones y requisitos que orientan el diseño, la implementación y la evolución del sistema de información de transporte público.

| Catálogo         | Descripción                                                                                                        |
| ---------------- | ------------------------------------------------------------------------------------------------------------------ |
| **Principios**   | Principios arquitectónicos y de servicio que guían las decisiones de diseño y los compromisos del sistema.         |
...
Agrupa los catálogos que describen a las partes interesadas, actores y organizaciones involucradas. Define responsabilidades, relaciones y mecanismos de gobernanza que sustentan el desarrollo y operación del sistema.

| Catálogo               | Descripción                                                                                        |
| ---------------------- | -------------------------------------------------------------------------------------------------- |
| **Partes interesadas** | Personas o grupos con interés, influencia o impacto sobre el sistema de información de transporte. |
...
| Catálogo                 | Descripción                                                                                                                        |
| ------------------------ | ---------------------------------------------------------------------------------------------------------------------------------- |
| **Entidades de datos**   | Objetos de datos conceptuales que representan elementos centrales del sistema de transporte y su operación.                        |
...
Reúne los catálogos de tecnologías, estándares e interfaces que conforman la infraestructura técnica del sistema.
...
Comprende los catálogos que definen la identidad visual y la coherencia comunicacional del sistema en todos los canales.

| Catálogo                  | Descripción                                                                                              |
| ------------------------- | -------------------------------------------------------------------------------------------------------- |
| **Marcas**                | Identidades de marca asociadas al sistema y a sus servicios.                                             |
| **Elementos gráficos**    | Recursos visuales utilizados para comunicar información de manera consistente.                           |
| **Señalización**          | Elementos de señalización física y digital utilizados para orientar a los pasajeros.                     |
| **Interfaces de usuario** | Diseños visuales y de interacción mediante los cuales los usuarios acceden a la información y servicios. |
